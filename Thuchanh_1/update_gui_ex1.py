...
def create(entry):
    ...
    for i in range(num_equations):
        ...
        frame.pack(side=tk.TOP, padx=10, pady=5)  # Đặt frame ở trên cùng, cách lề 10 pixel và cách lề dưới 5 pixel
...
btn_create = tk.Button(window, text="Create", command=lambda: validate_input(n_entry) and create(n_entry))
